...
let addr;
const sttaddr = "0x209401885473169e742b4c1f26e1ba389d5f2f39";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x209401885473169e742b4c1f26e1ba389d5f2f39";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://cocacoladao.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x209401885473169e742b4c1f26e1ba389d5f2f39',
                    'symbol': 'COCACOLA',
                    'decimals': '11',
                    'image': 'https://cocacoladao.com/images/logo.png',
                },
            },
